    ...
    <div class="flex max-w-7xl mx-auto mt-8 px-4">
        ...
        <aside class="w-1/4 bg-white rounded shadow p-4 dark:bg-gray-700">
            ...
            <ul class="space-y-2 text-gray-700 dark:text-white">
                ...
                <li><a href="data_artikel.php" class="block hover:text-cyan-600 dark:hover:text-cyan-300"">Kelola Artikel</a></li>
                <li><a href=" data_gallery.php" class="block hover:text-cyan-600 dark:hover:text-cyan-300"">Kelola Gallery</a></li>
                <li><a href=" about.php" class="block font-semibold text-cyan-400">About</a></li>
                <li><a href="data_contactform.php" class="block hover:text-cyan-600 dark:hover:text-cyan-300"">Contact Form</a></li>
                <li><a href=" data_komentar.php" class="block hover:text-cyan-600 dark:hover:text-cyan-300"">Kelola komentar</a></li>
                <li>
                    <a href=" logout.php" onclick="return confirm('Apakah anda yakin
ingin keluar?');" class="block text-red-600 hover:underline font-medium dark:text-red-300">Logout</a><br><br>
                </li>
                <li class="ml-auto">
                    <div class="flex ">
...
mb-1 dark:text-white">About</label>
                    <textarea id="about" name="about" rows="5" required class="w-full p-2 border rounded focus:outline-none focus:ring
focus:border-cyan-600 dark:focus:border-cyan-300"></textarea>
                </div>
                <div class="flex justify-end space-x-4">
                    <button type="submit"
                        class="bg-cyan-600 text-white px-4 py-2 rounded hover:bg-cyan-800 transition">Simpan</button>
                    <a href="about.php"
