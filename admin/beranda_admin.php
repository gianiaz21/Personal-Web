    ...
    <div class="flex max-w-7xl mx-auto mt-8 px-4">
        ...
        <aside class="w-1/4 bg-white rounded shadow p-4 dark:bg-gray-700">
            ...
            <ul class="space-y-2 text-gray-700 dark:text-white">
                <li><a href="beranda_admin.php" class="block font-semibold text-cyan-700 dark:text-cyan-400">Beranda</a>
                </li>
...
keluar?');" class="block text-red-600 hover:underline font-medium dark:text-red-300">Logout</a>
                </li>
                <li class="ml-auto">
                    <div class="flex ">
...
tbl_gallery"));
        ...
        <main class="w-3/4 bg-white rounded shadow p-6 ml-6 dark:bg-gray-700">
            <div class="text-lg text-gray-800 mb-4 dark:text-white">
                Halo, <strong class="text-cyan-700 dark:text-cyan-500">
                    <?php echo $_SESSION['username'];
                    ?>
                </strong>! Apa kabar? 😊
            </div>
            <p class="text-sm text-gray-500 dark:text-white">Silakan gunakan menu di samping untuk
                mengelola data.</p>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-6">
                <div class="bg-white shadow rounded p-4 text-center border-t-4 border-cyan-600">
                    <h3 class="text-xl font-semibold text-cyan-700">Artikel</h3>
