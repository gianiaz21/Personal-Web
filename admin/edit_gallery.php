...
focus:border-cyan-500 dark:focus:border-cyan-300">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1 dark:text-white">Gambar
                        Saat Ini</label>
...
mb-1 dark:text-white">Ganti Gambar (Opsional)</label>
...
file:bg-cyan-100 file:text-cyan-700 hover:file:bg-cyan-200 dark:text-gray-100">
                </div>
                <div class="flex justify-end space-x-4">
                    <button type="submit"
                        class="bg-cyan-700 text-white px-4 py-2 rounded hover:bg-cyan-800 transition">Simpan
                        Perubahan</button>
