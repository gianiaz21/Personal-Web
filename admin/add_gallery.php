...
<body class="bg-gray-100 min-h-screen dark:bg-gray-900">
    ...
    <div class="flex max-w-7xl mx-auto mt-8 px-4">
        ...
        <aside class="w-1/4 bg-white rounded shadow p-4 dark:bg-gray-700">
            <h2 class="text-xl font-semibold text-blue-700 mb-4 text-center dark:text-cyan-500">MENU</h2>
...
mb-1 dark:text-white">Judul Gambar</label>
...
mb-1 dark:text-white">Pilih Gambar</label>
                    <input type="file" id="foto" name="foto" accept="image/*" required class="block w-full text-sm text-gray-600 dark:text-gray-100 file:mr-4 file:py-2
...
file:bg-cyan-100 file:text-cyan-700 hover:file:bg-cyan-200">
                ...
                <div class="flex justify-end space-x-4">
                    <button type="submit"
                        class="bg-cyan-700 text-white px-4 py-2 rounded hover:bg-cyan-800 transition">Simpan</button>
